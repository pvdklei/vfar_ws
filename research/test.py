...
from pipeline import LineDetectionPipeline
...
def save_results(output_folder: str, config_id: int, config: Dict, metrics: Dict, 
                 steps: List, pipeline: LineDetectionPipeline):
