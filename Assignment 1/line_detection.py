...
def detect_in_frame(frame, bin_t=250, votes=30, min_length=50, max_gap=15):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--bin_t", help="Threshold for binarizing the image", default=250)
    parser.add_argument("-v", "--votes", help="HoughLines parameter of min. nr. votes", default=30)
    parser.add_argument("--min_length", help="HoughLines parameter of min. line length", default=50)
    parser.add_argument("--max_gap", help="HoughLines parameter of max. line gap", default=15)
